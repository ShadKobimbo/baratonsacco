...
CREATE TABLE `nextofkin` (
  ...
  `kinsecondname` text NOT NULL,
  `kinnationalid` varchar(8) NOT NULL,
  `relation` text NOT NULL,
  `kinmobile` int(13) NOT NULL,
  `kinaddress` varchar(25) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `nextofkin` (`id`, `kinfirstname`, `kinsecondname`, `kinnationalid`, `relation`, `kinmobile`, `kinaddress`) VALUES
(1, 'james', 'jimmy', '12424242', 'Uncle', 2147483647, '25500 kansas'),
(2, 'james', 'jimmy', '12424242', 'Uncle', 2147483647, '25500 kansas'),
(3, 'james', 'jimmy', '12424242', 'Uncle', 2147483647, '25500 kansas'),
(4, 'james', 'jimmy', '12424242', 'Uncle', 2147483647, '25500 kansas'),
(5, 'james', 'jimmy', '12424242', 'Uncle', 2147483647, '25500 kansas'),
(6, 'Daniel', 'Kobimbo', 'A017075', 'Brother', 718406563, 'Nakuru');
...
(8, 'Vera', 'jimmy', '124252345', 'Techy', '34523453', 'UEAB 2500', 6969, 734976293, 'University Of Eastern Afr', 'ISC', 'sdnas;dkflsdmcs;kdvn;irnapvr'),
(9, 'Vera', 'jimmy', '124252345', 'Techy', 'A017075', 'UEAB 2500', 6969, 734976293, 'University Of Eastern Afr', 'ISC', 'dfshsh'),
(10, 'Vera', 'jimmy', '124252345', 'Techy', '34523453', 'UEAB 2500', 6969, 734976293, 'University Of Eastern Afr', 'ISC', 'dfhsfjfyjjstyj'),
(11, 'Vera', 'jimmy', '124252345', 'Techy', 'A017075', 'UEAB 2500', 6969, 734976293, 'University Of Eastern Afr', 'ISC', 'ftgjntfy'),
(12, 'Vera', 'Sidika', '124252345', 'Techy', 'A017075', 'UEAB 2500', 6969, 734976293, 'University Of Eastern Afr', 'ISC', 'hjhj'),
(13, 'Vera', 'Sidika', '124252345', 'Techy', 'A017075', 'UEAB 2500', 6969, 734976293, 'University Of Eastern Afr', 'ISC', 'hjhj'),
(14, 'Vera', 'Sidika', '124252345', 'Techy', 'A017075', 'UEAB 2500', 6969, 734976293, 'University Of Eastern Afr', 'ISC', 'hjhj'),
(15, 'Shad', 'Kobimbo', '124252345', 'Techy', 'A017075', 'UEAB 2500', 6969, 734976293, 'University Of Eastern Afr', 'ISC', 'Testing for phase two of the form');
...
--
ALTER TABLE `testing`
  MODIFY `entryno` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
